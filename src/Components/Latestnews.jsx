            ...
            <div className="pagination">
              ...
              >
                ...
                <div className="Newsdescription">
                  For years, harvesting pumas has been used as a way to maintain
              ...
              >
                ...
                <br />
                <div className="Newsdescription">
                  How is jaguar conservation related to fighting climate change?
              ...
              >
                ...
                <br />
                <div className="Newsdescription">
                  Bridging borders to protect jaguars, rangers and scientists
                  from Honduras and Guatemala are collecting
                </div>
              </div>
            </div>
          </Carousel.Item>
            ...
            <div className="pagination">
              ...
              >
                ...
                <div className="Newsdescription">
                  ...
                  dedication, and the ability to adapt. Since 2013, we have been
                  working with our...
                </div>
              </div>
              <div
              ...
              >
                ...
                <br />
                <div className="Newsdescription">
                  Known for their elusive nature, snow leopards are referred to
                  by locals as “mountain ghosts” and are very hard to find in
                  India. However, we...
                </div>
              </div>
              <div
              ...
              >
                ...
                <br />
                <div className="Newsdescription">
                  Snares are silent killers laid by poachers across wild places
                  to trap and kill animals for the illegal bushmeat trade. Every
          ...
          <Carousel.Item>
            <div className="pagination">
              ...
              >
                ...
                <br />
                <div className="Newsdescription">
                  The snow leopard is a notoriously elusive species, inhabiting
                  some of the most remote and inaccessible tracts of Central and
                  South Asia. Still...
                </div>
              </div>
              <div
              ...
              >
                ...
                <br />
                <div className="Newsdescription">
                  The fishing cat (Prionailurus viverrinus), also known as the
                  “cat that barks” — for its dog-like barking vocalizations, is
                  a small cat species. They are one....
                </div>
              </div>
            </div>
          </Carousel.Item>
